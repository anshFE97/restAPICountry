...
const Counitries: React.FC<CountriesProps> = ({country}) => {
    
  return (
    <div className='bg-[#2B3945] rounded-md cursor-pointer transform hover:scale-105 transition xs:w-[320px]'>
        <div className='h-[100%]'>
            <div className='h-[50%]'>
                <img src={country.flags.svg} alt="demo" className='rounded-t-md object-cover h-full w-full' />
            </div>
